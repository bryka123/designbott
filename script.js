...
module.exports = new Script({
    ...
    start: {
        receive: (bot) => {
            return bot.say(`Hello! Please choose your language. Bonjour ! Choisissez votre langue, s'il vous plait.\n%[English](postback:morea) %[Français](postback:francais)`)
            //return bot.say(`Select Room \n%[Living Room](postback:livingroom) %[Bedroom](postback:bedroom) %[Dining Room](postback:diningroom) %[More rooms](postback:english)`)
                .then(() => 'speak');
        }
    },
